...
public class Program01 {
	...
	public static void main(String[] args) {
		...
		x.remove(0); // removes 0th element and shifts the elements
		System.out.println(x.get(0));
		
		Integer[] y= {30,50,60,10,70,90,80,30};
		x.addAll(Arrays.asList(y)); // adds all elements from above array  to the existing list after conversion of array to list
		System.out.println(x); 
